...
@Entity
@Table(name = "pooja_item_occasion_mapping", uniqueConstraints = {
...
public class PoojaItemOccasionMapping {
        ...
        @JoinColumn(name = "pooja_item_id", nullable = false, foreignKey = @ForeignKey(name = "fk_pooja_item_mapping_item"))
        private PoojaItem poojaItem;

        @ManyToOne(fetch = FetchType.LAZY, optional = false)
        @JoinColumn(name = "occasion_id", nullable = false, foreignKey = @ForeignKey(name = "fk_pooja_item_mapping_occasion"))
